...
reaches it is a **drop you write via `scripts/bosun_emit.py drop`** (which the Mate's
...
- **You have NO Write/Edit tools.** Your ONLY writes go through `scripts/bosun_emit.py`
...
- The **Mate bootstraps you**: `/ship-watch-start` calls `scripts/launch-bosun.sh --ensure`
