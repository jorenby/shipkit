...
SHIP_ROOT defaults to the parent of this scripts/ dir; override with the SHIP_ROOT env.
"""
import os
import sys
import json
...
SHIP_ROOT = Path(os.environ.get("SHIP_ROOT", Path(__file__).resolve().parent.parent)).resolve()
